          ...
          <div class="row column1">
            <div class="col-md-12">
              <div class="white_shd full margin_bottom_30">
               ...
               <a href="#" class="btn btn-dark " style="float: right;"><font class="fa fa-list"></font>&nbsp;Upload des documents manquant apres les demandes</a>
                                </div> 
                                <div class="full price_table padding_infor_info">
                                  <form class="form-horizontal" method="post" id="myform" action="<?php echo base_url('administration/Fichiers_Manquant_All/update_doc')?>"  enctype="multipart/form-data">                                 
                                    <!-- s -->
                                   <div class="row">    
                                  <div class="form-group col-lg-4"> 
                                   <label style="font-weight: 900; color:#454545" id="PROCESS">Processus</label>   
...
<script type="text/javascript">
   ...
   function get_doc() 
 {
    ...
    // if (trans !='') 
    // {   
     $.post('<?php echo base_url('index.php/administration/Fichiers_Manquant_All/get_doc')?>',
    {
