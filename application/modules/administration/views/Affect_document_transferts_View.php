              ...
              <div class="white_shd full margin_bottom_30">
               ...
               <a href="<?= base_url() ?>administration/Affect_document_transferts/liste" class="btn btn-info" style="float: right;"><font class="fa fa-list"></font> Liste</a>
                                ...
                                <div class="full price_table padding_infor_info">
                                  <form class="form-horizontal" method="post" id="myform" action="<?php echo base_url('administration/Affect_document_transferts/save')?>"  enctype="multipart/form-data">                                 
                           ...
                           echo '<option value="'.$valu['PROCESS_ID'].'">'.$valu['DESCRIPTION_PROCESS'].'</option>';
                             ...
                             ?>
                               ...
                               <select class="form-control" id="ID_TYPE_TRANSFERT"   name="ID_TYPE_TRANSFERT" >
                                <!-- onchange="get_input()" -->
                               <option value="0">Sélectionner</option>
                              <?php
                           ...
                           echo '<option value="'.$valu['ID_TYPE_TRANSFERT'].'">'.$valu['DESCRIPTION_TRANSFERT'].'</option>';
                             ...
                             ?>
                                    ...
                                    <div class="form-group col-lg-3">    
                                     <label style="font-weight: 900; color:#454545" id="PROCESS">Type acheteur</label>
                               <select class="form-control" id="TYPE_ACHETEUR"  name="TYPE_ACHETEUR" onchange="do_things()" >
                                <!-- onchange="get_input()" -->
                               <option value="0"><?=lang('slect')?></option>

                                <option value="1">Personne physique</option>

                                <option value="2">Personne morale</option>

                                 <option value="3">Copropriétaire</option>
                           
                         </select>
                                     <span class="help-block" style="color: red"></span>

                                   </div>
                                      <div class="form-group col-lg-3" id="CATEGG" style="display:none">    
                                     <label style="font-weight: 900; color:#454545" id="PROCESS">Categorie requerant</label>
                               <select class="form-control" id="CATEGORIE"  name="CATEGORIE" onchange="do_things2()" >
                                <!-- onchange="get_input()" -->
                               <option value="0">Sélectionner</option>
                      ...
                      <select class="form-control" id="ID_POSTE"  name="ID_POSTE" onchange="get_stage()">
                               <option value="">Sélectionner</option>
                                    ...
                                    <span class="help-block" style="color: red"></span>
                                     ...
                                     <div class="form-group col-lg-3">    
                                     <label style="font-weight: 900; color:#454545" id="lettre_demande">Stage<font color="red">*</font></label>
                      <select class="form-control" id="STAGE_ID"  name="STAGE_ID" onchange="action_func()">
                               <option value="">Sélectionner</option>
                                  ...
                                  <h5 style="margin-left: 20px;margin-right: 20px">Affectation des documents</h5>
                                   ...
                                   <div class="form-group col-lg-12">
                                    <button type="submit" class="btn btn-info form-control" id="btnSave" style="margin-top: 20px" class="main_bt" disabled="true">Affecter les documents</button>
                                  </div>
                                </div>
                              </form>
                            </div>
...
<script type="text/javascript">
   ...
   function get_catego() 
 {
    ...
    // if (trans !='') 
    // {   
     $.post('<?php echo base_url('index.php/administration/Affect_document_transferts/get_catego')?>',
    {
    ID_TYPE_TRANSFERT:ID_TYPE_TRANSFERT,
