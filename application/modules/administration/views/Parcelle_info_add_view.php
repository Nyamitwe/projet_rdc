              ...
              <!-- <hr> -->
                ...
                <div class="row">
                  <ul class="nav nav-tabs" style="margin-left:20px">
                    <li class="nav-item">
                      <a class="nav-link" aria-current="page" href="#"><?=lang('title_infos_prop')?></a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" href="#"><?=lang('title_infos_parcel')?></a>
                    </li>
                  </ul>
                </div>
                  
                 <form name="myform" method="post" class="form-horizontal" action="<?= base_url('administration/Numerisation/add_info_parcelle'); ?>"  enctype="multipart/form-data">
                 ...
                 <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="text" oninput="validateValue(this)" class="form-control" name="NUM_PARCEL">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                          ...
                          <input type="text" class="form-control" oninput="validateInfo(this)" name="NUMERO_SPECIAL">
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" oninput="validateInfoVolume(this)" class="form-control" name="VOLUME">
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" oninput="validateInfoFolio(this)" class="form-control" name="FOLIO">
                        ...
                        <div class="col-md-4">
                          ...
                          <input type="text"  oninput="validateInfoFolio(this)" class="form-control" name="SUPER_HA" id="SUPER_HA">
                        ...
                        <div class="col-md-4">
                          ...
                          <input type="text"  oninput="validateInfoFolio(this)" class="form-control" name="SUPER_ARE" id="SUPER_ARE">
                          <?php echo form_error('SUPER_ARE', '<div class="text-danger">', '</div>'); ?>                                
                        </div> 

                        <div class="col-md-4">
                          <label><?=lang('superficie_ca')?><font class="text-danger">*</font></label>
                          <input type="text"   oninput="validateInfoFolio(this)"  class="form-control" name="SUPER_CA" id="SUPER_CA">
                                ...
                                <div class="col-md-6">
                                  ...
                                  <select class="form-control"  name="USAGE" id="USAGE">
                                    ...
                                    <?php foreach($usagers_proprietes as $usager_propriete) { 
                                      if ($usager_propriete['ID_USAGER_PROPRIETE']==set_value('ID_USAGER_PROPRIETE')) { 
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <input type="text" oninput="validateValue(this)" class="form-control" name="NUM_CADASTRE" id="NUM_CADASTRE">
                    ...
                    <div class="row">
                     <!--<div class="col-md-6" style="margin-top: 10px">
                       <button class="btn btn-info left" onclick="prec(this.value);"  type="button"><?=lang('btn_precedent')?></button>
                     </div>  -->
                     
                     <div class="col-md-6" style="margin-top: 10px">
                       <button class="btn btn-info right"  type="submit"><?=lang('save_btn')?></button>
                     </div> 
                   </div> 
                  </form>
...
function prec()
{
    ...
    window.location.href="<?= base_url('administration/Numerisation/index/'); ?>"+user_id;
