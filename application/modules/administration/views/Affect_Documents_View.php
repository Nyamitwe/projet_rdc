          ...
          <div class="row column1">
            <div class="col-md-12">
              <div class="white_shd full margin_bottom_30">
               ...
               <a href="<?= base_url() ?>administration/Affect_Documents/liste" class="btn btn-dark" style="float: right;"><font class="fa fa-list"></font> Liste</a>
                                </div> 
                                <div class="full price_table padding_infor_info">
                                  <form class="form-horizontal" method="post" id="myform" action="<?php echo base_url('administration/Affect_Documents/save')?>"  enctype="multipart/form-data">                                 
                                    <div class="row mb-4" style="margin-left: 20px;margin-right: 20px">
                                   <div class="form-group col-lg-3">    
                                     <label style="font-weight: 900; color:#454545" id="PROCESS"><?=lang('proces')?></label>
                           ...
                           echo '<option value="'.$valu['PROCESS_ID'].'">'.$valu['DESCRIPTION_PROCESS'].'</option>';
                             ...
                             ?>
                                   ...
                                   <div class="form-group col-lg-3">    
                                     <label style="font-weight: 900; color:#454545" id="lettre_demande"><?=lang('service')?><font color="red">*</font></label>
                      <select class="form-control" id="SERVICE_ID"  name="SERVICE_ID" onchange="get_poste()">
                            ...
                            echo '<option value="'.$val['SERVICE_ID'].'">'.$val['DESCRIPTION'].'</option>';
                             ...
                             ?>
                                   ...
                                   <div class="form-group col-lg-3">    
                                     <label style="font-weight: 900; color:#454545" id="lettre_demande"><?=lang('post')?><font color="red">*</font></label>
                      ...
                      <select class="form-control" id="STAGE_ID"  name="STAGE_ID" onchange="action_func()">
                               <option value=""><?=lang('select')?></option>
                                   ...
                                   <hr>
                                  <h5 style="margin-left: 20px;margin-right: 20px"><?=lang('affectation_document')?></h5>
                                   <hr>
                                   ...
                                   <div class="form-group col-lg-12">
                                    <button type="submit" class="btn btn-info form-control" id="btnSave" style="margin-top: 20px" class="main_bt" disabled="true"><?=lang('affecter_document')?></button>
                                  </div>
                                </div>
                              </form>
                            </div>
