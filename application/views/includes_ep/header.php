 <meta charset="UTF-8">
    ...
    <!-- bootstrap css -->
    <link rel="stylesheet" href="<?= base_url() ?>template_ep/css/bootstrap.min.css" />

    <!-- site css -->
    <link rel="stylesheet" href="<?= base_url() ?>template_ep/style.css" />
    <!-- responsive css -->

    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" />
    <!-- font awesome -->
    <link rel="stylesheet" href="<?= base_url() ?>template_ep/css/responsive.css" />
    <!-- color css -->
    <link rel="stylesheet" href="<?= base_url() ?>template_ep/css/colors.css" />
    <!-- select bootstrap -->
    <link rel="stylesheet" href="<?= base_url() ?>template_ep/css/bootstrap-select.css" />
    <!-- scrollbar css -->
    <link rel="stylesheet" href="<?= base_url() ?>template_ep/css/perfect-scrollbar.css" />
    <!-- custom css -->
    <link rel="stylesheet" href="<?= base_url() ?>template_ep/css/custom.css" />
    <!--[if lt IE 9]>
