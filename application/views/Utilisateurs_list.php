           ...
           <div class="page_title">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <!-- Split button -->
                <div class="btn-group">
                  <button type="button" class="btn btn-default" href="<?= base_url() ?>New_requerant" > <i style="color: blue" class="fa fa-plus-o" aria-hidden="true"></i> <label id="tasks_number"></label>Nouvel utilisateur</button>
