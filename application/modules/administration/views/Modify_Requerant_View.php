              ...
              <!-- <hr> -->
                ...
                <div class="row">
                 <!--  <ul class="nav nav-tabs" style="margin-left:20px">
                  ...
                  <div class="col-md-12">
                    <h4>Modification des infos du requerant</h4>
                  </div>
                </div>
                 <?php //echo $message; ?>
                 <form name="myform" method="post" class="form-horizontal" action="<?= base_url('administration/Numerisation/updateinforeq'); ?>"  enctype="multipart/form-data">
                 <div class="row">
                  <?php //echo validation_errors()?>
                    <div class="col-md-12">
                    <input type="hidden"  class="col-md-4 form-control" value="<?=$info['id']?>" name="id">
                   ...
                   <div class="col-md-6" style="margin-top:10px">
                    ...
                    <select class="form-control"  name="type_requerant_id"  id="type_requerant_id">
                      ...
                      foreach ($types_requerants as $key) {
                     if ($key['id']==$info['typereq']) 
                       {?>
                    ...
                    <select class="form-control info_perso_nationalite"  name="nationalite_id"  id="nationalite_id" <?=$info_nationalite?>>
                     ...
                     if ($nationalite['id']==$info['countrie']) 
                       {?>
                         <option value="<?=$nationalite['id']?>" selected=''><?=$nationalite['name']?></option>
                 ...
                 <div class="row col-md-12 info_perso_physique" <?=$info_physique?>>
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      ...
                      <input type="text" class="form-control" oninput="validateInput(this)" name="NOM_PRENOM_PROP" value="<?=$info['fullname']?>">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="hidden" class="form-control" name="PHOTO_PASSEPORT_PROP_OLD" value="<?=$info['profile_pic']?>">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="hidden" class="form-control" name="SIGNATURE_PROP_OLD" value="<?=$info['path_signature']?>">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      ...
                      <input type="text" class="form-control" oninput="validateValues(this)" name="NUM_CNI_PROP" value="<?=$info['cni']?>">
                    ...
                    <div class="col-md-3">
                      ...
                      <input type="hidden" class="form-control" name="CNI_IMAGE_PROP_OLD" value="<?=$info['path_cni']?>">
                      <?php echo form_error('CNI_IMAGE_PROP', '<div class="text-danger">', '</div>'); ?>                                
                    </div>

                  <div class="col-md-3">
                      <label><?=lang('date_delivrance')?><font class="text-danger">*</font></label>
                      <input type="date" class="form-control" id="DATE_DELIVRANCE" name="DATE_DELIVRANCE" max="<?=date('Y-m-d')?>"  value="<?=$info['date_delivrance']?>">
                    ...
                    <div class="col-md-3">
                      ...
                      <input type="text" class="form-control" oninput="validateInput(this)" name="LIEU_DELIVRANCE" maxlength="100" value="<?=$info['lieu_delivrance_cni']?>">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="email" autocomplete="off" class="form-control" name="EMAIL_PROP" id="EMAIL_PROP" value="<?=$info['email']?>">
                      <?php echo form_error('EMAIL_PROP', '<div class="text-danger">', '</div>'); ?>                                
                    </div>

                    <div class="col-md-6">
                      <label><?=lang('numero_telephone')?><font class="text-danger">*</font></label>
                      <input type="text" class="form-control" oninput="validatePhoneNumber(this)" minlength="8" maxlength="12" name="NUM_TEL_PROP"  value="<?=$info['mobile']?>" autocomplete="off">
                  ...
                  <div class="col-md-12"></div><br>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" oninput="validateInput(this)" id="NOM_PRENOM_PERE" name="NOM_PRENOM_PERE" value="<?=$info['father_fullname']?>">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" oninput="validateInput(this)" name="NOM_PRENOM_MERE" value="<?=$info['mother_fullname']?>">
                      ...
                      <select class="form-control" onchange="get_communes_naissance(this.value)"  name="PROVINCE_ID" id="PROVINCE_ID">
                        <option value=""><?=lang('selectionner')?></option>
                          ...
                          <?php foreach($provinces_naissance as $province) { 
                                    if ($province['PROVINCE_ID']==$info['provence_id']) { 
                ...
                <div class="row col-md-12 info_perso_morale" <?=$info_morale?>>
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="hidden" class="form-control" name="SIGNATURE_REPRESENTANT_OLD" value="<?=$info['path_signature']?>">
                    ...
                    <img id="preview" src="<?=base_url('uploads/doc_scanner/'.$info['SIGNATURE_PROP'].'')?>" alt="Image Preview" style="max-width: 100%; height: auto; border: 1px solid #ccc;"/>
                   </div>   -->                          
                  </div>
                    ...
                    <div class="row">
                     <div class="col-md-12" style="margin-top: 10px">
                       <button class="btn btn-info" id="submitButton" type="submit">Modifier</button>
                     </div>                           
                   </div> 
                  </form>
...
<script>
 ...
 <script>
  ...
  function get_communes_naissance($id)
  {
    ...
    $.ajax({
      url: "<?= base_url() ?>administration/Modify_Requerant/get_commune_naissance/"+PROVINCE_ID,
      type: "GET",
      dataType: "JSON",
  ...
  function get_zones($id)
  {
    ...
    $.ajax({
      url: "<?= base_url() ?>administration/Modify_Requerant/get_zone_parcelle/"+COMMUNE_ID,
      type: "GET",
      dataType: "JSON",
      success: function(data) {
        $('#ZONE_ID').html(data);
  ...
  function get_collines($id)
  {
    ...
    $.ajax({
      url: "<?= base_url() ?>administration/Modify_Requerant/get_colline_parcelle/"+ZONE_ID,
      type: "GET",
      dataType: "JSON",
      success: function(data) {
