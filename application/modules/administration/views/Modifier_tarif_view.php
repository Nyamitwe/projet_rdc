                  ...
                  <div class="card-body" style="padding: 5px;">
                    ...
                    <div class="row">
                      <div class="col-sm-8">
                        ...
                        <form class="form-horizontal" method="post" id="myform" action="<?php echo base_url('administration/Tarif/enregistrer')?>">
                          <input type="hidden" name="TARIF_ID" value="<?=$infos['TARIF_ID']?>" id="TARIF_ID">
                          <div class="form-group col-md-12">
                            <label for="exampleInputEmail1"><b><?=$infos['DESCRIPTION_TARIF']?></b></label>
                            <input type="number" name="MONTANT_TARIF" value="<?=$infos['MONTANT_TARIF']?>" class="form-control">  
