            ...
            <div class="row pb-5">
                <div class="col-md-8">
                    ...
                    <article class="mb-5 p-3" id="">
                        <header>
                            <div class="meta"><span class="author"><b><i class="fa fa-users"></i> </b> </span> <span class="date"><i class="fa fa-clock-o"></i> Publié le Publié le  <?=date('d/m/Y',strtotime($article_pub['DATE_PUBLICATION']))?></span> 
                            </div>
                            <h2>
                                <a href="">
                                    ...
                                    <div class="entry-content">
                                        <div class="row">
                                            <div class="col-lg-12 mb-3">
                                                <img src="<?=base_url('uploads/publication/'.$article_pub['IMAGE_PUBLICATION'])?>" alt=""  class="img-fluid w-70"/></div>
                                               <div class="col-lg-12">
