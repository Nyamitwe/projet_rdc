          ...
          <div class="col-md-12">
           <div class="page_title">
            ...
            <div class="row">
              <div class="col-md-6">
                <h2>
                  <i class="fa fa-bars" aria-hidden="true"></i> Liste des demandes de rendez-vous
                </h2>
              </div>
              <div class="col-md-3">
              </div>
             ...
             <div class="col-lg-12">
              ...
              <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  <button class="nav-link active" id="nav-tab-1" data-toggle="tab" data-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true"  onclick="showTab(0)">Rendez-vous en cours</button>
                  <button class="nav-link" id="nav-tab-2" data-toggle="tab" data-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false" onclick="showTab(1)"> Rendez-vous effectuées</button>
                  <button class="nav-link" id="nav-tab-3" data-toggle="tab" data-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false" onclick="showTab(2)"> Rendez-vous ajournées</button>
                  <button class="nav-link" id="nav-tab-4" data-toggle="tab" data-target="#nav-non-repondu" type="button" role="tab" aria-controls="nav-non-repondu" aria-selected="false" onclick="showTab(3)">Rendez-vous non repondu</button>
                </div>
              </nav>
              <br>
              <br>
              ...
              <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                  <div class="full price_table padding_infor_info">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 d-flex justify-content-end">
                            <div class="date-input-wrapper">
                              ...
                              <input type="date" id="date-input" name="date-input" onchange="get_date();">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <input type="hidden" id="tabdate" name="tabdate" >
                    <table id='mytable' class="table table-sm table-bordered table-hover table-striped" data-toggle="table" data-search="true" data-show-columns="true" data-pagination="true">
                     ...
                     <thead> 
                      <tr>
                        ...
                        <th scope='col'><center>Nom et prénom</center></th>
                        <th scope='col'><center>Objet du rendez-vous</center></th>
                        <th scope='col'><center>Date RDV</center></th>
                        <th scope='col'><center>Date Demande</center></th>
...
function get_liste(tabId) { 
  ...
  $("#mytable").DataTable({      
    ...
    "order":[[0, 'asc' ]],
    "ajax":{
      url:'<?=base_url()?>administration/Rdv/liste/' + tabId,
      type:"POST",
      dataType: "JSON",
      cache:false,
      data:{
