  							...
  							<div class="col-md-12">
  								<div class="white_shd full margin_bottom_30">
  									<div class="full graph_head">
  										<a href="#" class="btn btn-dark" style="float: lefet;">Modification du menu</a>
  										<br><br>
  										    <a href="<?=base_url('administration/Enregistrement_Menus/liste')?>" class="btn btn-primary" style="float: right;">Nouveau</a>
                              <br><br>
  									 <?=$this->session->flashdata('message')?> 
  									</div> 

  									<div class="full price_table padding_infor_info">
  										<form class="form-horizontal" method="post" id="myform" action="<?php echo base_url('administration/Enregistrement_Menus/modify')?>"  enctype="multipart/form-data">                                 
  										...
  										<input type="hidden" name="id" value="<?=$val['ID_PMS_MENU']?>">

  										<input type="TEXT" name="ID_PMS_MENU" id="ID_PMS_MENU" class="form-control" value="<?=$val['DESC_MENU']?>">
  													...
  													<select class="form-control" name="TYPE_MENU" id="TYPE_MENU">
  														...
  														<?php foreach ($type_menu as $key => $value) 
  														{
  															...
  															if ($value['ID_TYPE_MENU']==$val['ID_TYPE_MENU']) {
  															$select='selected';
  															}
  															
  														?>
  															<option value="<?=$value['ID_TYPE_MENU'];?>" <?=$select;?> ><?=$value['DESC_TYPE_MENU'];?></option>
                                       ...
                                       <span class="help-block" id="error3" style="color: red"></span>
  												...
  												<div class="form-group col-lg-12">    
  													...
  													<input type="TEXT" name="LINK" value="<?=$val['MENU_LINK']?>" id="LINK" class="form-control">
