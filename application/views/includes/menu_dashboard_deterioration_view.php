...
<div class="row">
        <div class="col-md-3">
            <div class="card border-info mx-sm-1 p-3">
                ...
                <div class="text-info text-center mt-3"><h5><?=lang('MY_TASKS')?></h5></div>
       ...
       <!--  <div class="col-md-3">
         ...
         <div class="col-md-3">
            <div class="card border-success mx-sm-1 p-3">
                <div class="card border-success shadow text-success p-3 my-card"><span class="fa fa-inbox" aria-hidden="true"></span></div>
                <div class="text-success text-center mt-3"><h5><?=lang('COMPLETED_TASKS')?></h5></div>
        ...
        <div class="col-md-3">
            <div class="card border-danger mx-sm-1 p-3">
                ...
                <div class="text-danger text-center mt-3"><h5><?=lang('n_message')?></h5></div>
        ...
        <div class="col-md-3">
            <div class="card border-warning mx-sm-1 p-3">
                ...
                <div class="text-warning text-center mt-3"><h5><?=lang('SIGNING_ITEMS')?></h5></div>
