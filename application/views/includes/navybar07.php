                    ...
                    <?php 
                     ...
                     ?>
                      ...
                      <li class="<?php if($get_url == 'Registres') echo 'active' ?>"><a href="<?php echo base_url() ?>registres/Registres"><i class="fa fa-book lightgreen_color"></i> <span><?= lang('menu_registre') ?></span></a></li>
                       ...
                       <li class="<?php if($get_url == 'Dashboard_Att_Possession') echo 'active' ?>"><a href="<?php echo base_url() ?>dashboard/Dashboard_Att_Possession"><span><?= 'Attestation de possession'?></span></a>
                        </li>

                        <li class="<?php if($get_url == 'Dashboard_Att_non_possession') echo 'active' ?>"><a href="<?php echo base_url() ?>dashboard/Dashboard_Att_non_possession"><span><?= 'Attestation de non possession'?></span></a>
                        </li>
