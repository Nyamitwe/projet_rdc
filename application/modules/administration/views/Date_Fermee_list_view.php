                  ...
                  <div class="col-md-12">
                     <div class="white_shd full margin_bottom_30">
                       ...
                       <a href="#" class="btn btn-dark" style="float: left;">Liste des menus</a>
                           ...
                           <br>
                            <a href="<?=base_url('administration/Date_Fermee/')?>" class="btn btn-primary" style="float: right;">Nouveau</a>
                              <br><br>
                             ...
                             <table id="mytable" class="table table-sm table-bordered table-striped" data-toggle="table" data-search="true" data-show-columns="true" data-pagination="true">
                              <thead class="">
                               <tr>
                                   ...
                                   <th style='width:100px'><center><font color="black" size="3"><label>Nature du congé</label></font></center></th>
                                   <th style='width:100px'><center><font color="black" size="3"><label>Date du congé</label></font></center></th>
                                    <th style='width:100px'><center><font color="black" size="3"><label>Type de congé</label></font></center></th>                                
...
<script>
  ...
  {  
   ...
   $("#mytable").DataTable({
    ...
    "oreder":[[ 1, 'asc' ]],
    "ajax":{
      url: "<?php echo base_url('administration/Date_Fermee/liste/');?>", 
      type:"POST",
      data : {},
      beforeSend : function() {
      }
