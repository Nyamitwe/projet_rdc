            ...
            <div class="col-md-12">
             <div class="page_title">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <h2>
                        <i class="fa fa-bars" aria-hidden="true"></i> Liste des demandes d'audience
                    </h2>
                </div>
                <div class="col-md-3">
                </div>
         ...
         <div class="col-lg-12">
                <nav>
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="nav-home-tab" data-toggle="tab" data-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Audience En cours</button>
                    <button class="nav-link" id="nav-profile-tab" data-toggle="tab" data-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Audience effectuées</button>
                    <button class="nav-link" id="nav-contact-tab" data-toggle="tab" data-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Audience ajournées</button>
                     <button class="nav-link" id="nav-non-repondu-tab" data-toggle="tab" data-target="#nav-non-repondu" type="button" role="tab" aria-controls="nav-non-repondu" aria-selected="false">Audience non repondu</button>
                </div>
            </nav>
            <br>
            <br>
            ...
            <div class="tab-content" id="nav-tabContent">
                           ...
                           <table id='mytable' class="table table-sm table-bordered table-hover table-striped" data-toggle="table" data-search="true" data-show-columns="true" data-pagination="true">
                             ...
                             <thead> 
                                <tr>
                                    ...
                                    <th scope='col'><center>Objet de la visite</center></th>
                                    <th scope='col'><center>Fonction</center></th>
                                    <th scope='col'><center>Contact</center></th>
                                    <!-- <th scope='col'><center>CNI</center></th> -->
                ...
                <div class="tab-pane fade" id="nav-non-repondu" role="tabpanel" aria-labelledby="nav-non-repondu-tab">
                        <div class="full price_table padding_infor_info">
...
<script type="text/javascript">
  ...
  // ],
      "order":[[0, 'asc' ]],
      "ajax":{
        url:'<?=base_url()?>administration/Liste_Demande_Audience/liste/',
        data:{
