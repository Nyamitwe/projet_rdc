                ...
                <div class="card">
                              ...
                              <div class="alert alert-success alert-dismissible fade show">
                                 ...
                                 <div class="col-md-12">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item"><strong>Objectif: </strong>&nbsp;<?=$infos['MOTIF_URGENCE']?></li>
                                         <li class="list-group-item"><strong>Date audience: </strong>&nbsp;<?=$infos['JOUR_AUDIENCE']?></li>
                 ...
                 <div class="row">
                   <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                     <a href="<?= base_url('administration/Liste_Audiences/statut/'.$infos['ID_TRAITEMENT_AUDIENCE'].'')?>/1" class='form-control main_bt'>Présence</a>
                   </div>
                 </div>
                  <?php
                }
