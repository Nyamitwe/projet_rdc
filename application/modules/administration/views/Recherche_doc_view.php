      ...
      <div class="container-fluid" style="padding: 0px;">
       ...
       <div class="row column1">
          ...
          <div class="white_shd full margin_bottom_30" style="padding: 0px;">
           ...
           <div class="full price_table padding_infor_info">
            ...
            <div class="row">
              <div class="col-md-12">
                <br>
                <center><h2>Recherche d'une parcelle dans Docbox</h2></center>
              </div>
            </div>
        ...
        <div class="col-md-3">
          ...
          <div class="col-md-12">
            <input type="button" id="voirDossierBtn" name="dossier" onclick="getDocInitial();" value="Voir dossier initial">          
          </div>
        </div>
      </form>
    </div>
...
<script>
  function getSearchResults1(id)
  {
    ...
    {
     $.ajax({
        url : "<?=base_url()?>administration/Recherche/recherche2/"+PROVINCE+"/"+PARCELLE_SEARCH+"/"+NATURE_DOC,
        type: "POST",
        dataType: "JSON",
        ...
        success: function(data)
        {
          if (data.status==1) {
            ...
            // Hide the button if either value is empty or null
            if(!data.nom_sous_rep || !data.token_sous_rep)
            {
              document.getElementById('voirDossierBtn').style.display = 'none';
            } 
            else
            {
              document.getElementById('voirDossierBtn').style.display = 'inline-block'; // or 'block'
            }
  ...
  function getDocInitial()
  {
     ...
     var nom_sous_repertoire = $("#nom_sous_repertoire").val();
     var parcelle_numero = $("#parcelle").val();
     // alert(nom_sous_repertoire);
     window.location.href="<?= base_url('administration/Recherche/afficher_doc_initial/'); ?>"+token_de_sous_repertoire+"/"+nom_sous_repertoire;
  }
</script>
