              ...
              <div class="col-md-12">
                <div class="card">
                 ...
                 <div class="row">
                        ...
                        <div class="col-md-12">
                              <div class="alert alert-success alert-dismissible fade show">
                                 ...
                                 <div class="col-md-12">
                                    <ul class="list-group">
                                        <li class="list-group-item"><strong>CNI: </strong>&nbsp;<?=!empty($infos['NUM_CNI']) ? $infos['NUM_CNI'] :''?></li>
                                        <li class="list-group-item"><strong>Adresse: </strong>&nbsp;<?=!empty($infos['ADRESSE_PHYSIQUE']) ? $infos['ADRESSE_PHYSIQUE'] : '' ?></li>
                                        <li class="list-group-item"><strong>Objectif: </strong>&nbsp;<?=!empty($infos['DESC_TYPE_DEMANDE_AUDIENCE']) ? $infos['DESC_TYPE_DEMANDE_AUDIENCE'] :''?></li>
                 ...
                 <div class="row">
                  ...
                  <?php if ($rdv_deja_donne==1) {?>
                    <div class="col-md-12">
                      <span href="#" class='form-control main_bt'>Rendez - vous attribué</span>
                  </div>
                <?php  }else{ ?>
                   <div class="col-md-12">
                     <a href="<?= base_url('administration/Liste_Demande_Rdv/tache/'.md5($infos['ID_DEMANDEUR_AUDIENCE']).'')?>" class='form-control main_bt'>Donner le Rendez-vous!</a>
                   </div>
                 <?php } ?>
                 </div>
