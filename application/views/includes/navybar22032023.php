...
<nav style="background-image: url(<?php echo base_url() ?>template/images/bg_sidebar.png); background-size: cover; background-repeat: no-repeat" id="sidebar">
 ...
 -->
                        ...
                        <li class="<?php if($get_url == 'Numerisation') echo 'active' ?>">
                        <a href="<?php echo base_url() ?>numerisation/Numerisation" ><i class="fa fa-plus-circle lightgreen_color"></i> <span><?= 'Document numerisé' ?></span></a>
               ...
               <li class="<?php if($get_url == 'Rapport_Titre_Opposition') echo 'active' ?>"><a href="<?php echo base_url() ?>dashboard/Rapport_Titre_Opposition"><span><?= 'Demande d\'opposition'?></span></a>
                        </li>

                  <li class="<?php if($get_url == 'Rapport_Titre_Demande_Info_Notaire') echo 'active' ?>"><a href="<?php echo base_url() ?>dashboard/Rapport_Titre_Demande_Info_Notaire"><span><?= 'Demande d\'information cas du notaire'?></span></a>
                        </li>
 
                <li class="<?php if($get_url == 'Rapport_Titre_Req_Expert_Justice') echo 'active' ?>"><a href="<?php echo base_url() ?>dashboard/Rapport_Titre_Req_Expert_Justice"><span><?= 'Réquisition d\'un expert par la justice'?></span></a>
                        </li>
                     ...
                     <hr>
                        ...
                        <ul class="collapse list-unstyled" id="parametres">
                           <!-- <li class="activated"><a href="#"><span>Parcelles</span></a></li> -->
                             ...
                             <li class="<?php if($get_url == 'Publication') echo 'active' ?>"><a href="<?php echo base_url() ?>publication/Publication"><span>Publication</span></a></li>
                           ...
                           <li class="<?php if($get_url == 'Backend_Users') echo 'active' ?>"><a href="<?php echo base_url() ?>ihm/Backend_Users/liste"><span>Utilisateurs</span></a></li>
                             ...
                             <li class="<?php if($get_url == 'Notaires') echo 'active' ?>"><a href="<?php echo base_url() ?>ihm/Notaires/liste"><span>Notaires</span></a></li>
