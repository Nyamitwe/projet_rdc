          ...
          <div class="row column1">
            <div class="col-md-12">
              <div class="white_shd full margin_bottom_30">
               ...
               <a href="<?= base_url() ?>administration/Droits/liste" class="btn btn-dark " style="float: right;"><font class="fa fa-list"></font><?=lang('droits_list')?></a>
                                </div> 
                      ...
                      <select class="form-control" id="ID_POSTE"  name="ID_POSTE" onchange="action_func()">
                               <option value=""><?=lang('selectionner')?></option>
                                   ...
                                   <hr>
                                  <h5 style="margin-left: 20px;margin-right: 20px"><?=lang('droit_attribution')?></h5>
                                   <hr>
                                   ...
                                   <div class="form-group col-lg-12">
                                    <button type="submit" class="btn btn-info form-control" id="btnSave" style="margin-top: 20px" class="main_bt" disabled="true"><?=lang('droit_attribution_element')?></button>
                                  </div>
                                </div>
                              </form>
                            </div>
