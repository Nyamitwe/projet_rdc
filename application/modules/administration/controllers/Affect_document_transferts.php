 ...
 */
   ...
   class Affect_document_transferts  extends CI_Controller 
   {
    ...
    $doc=$this->Model->getRequete('SELECT pms_documents.* from pms_documents JOIN pms_transfert_document_vs_requerant on pms_documents.`ID_DOCUMENT`=pms_transfert_document_vs_requerant.DOCUMENT_TRANSFERT_ID where ID_TYPE_DOCUMENT=1 and SCAN_TRAITEMENT=0 GROUP BY ID_DOCUMENT order by DESC_DOCUMENT');
    ...
    $this->load->view('Affect_document_transferts_View',$data);
    }
