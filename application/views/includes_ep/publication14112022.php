...
<body>
    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-light shadow sticky" data-offset="0">
            <div class="container">
                <a href="#" class="navbar-brand"><img alt="" width='200' src='<?php echo base_url()?>/assets/img/pms_logo_2.svg'></a>
                ...
                <div class="col-md-8">
                    ...
                    foreach ($results as $key) {
                        ...
                        <article class="mb-5 p-3" id="">
                            <header>
                                <div class="meta"><span class="author"><b><i class="fa fa-users"></i> Auteur: Name</b> - </span> <span class="date"><i class="fa fa-clock-o"></i> Publié le <?=date('d-m-Y',strtotime($key->DATE_PUBLICATION))?></span> 
                                </div>
                                ...
                                <h2>
                                   <a href="">
                                    ...
                                    <div class="entry-content">
                                        <div class="row">
                                            <div class="col-lg-6 article-description">
                                                <a href=""> <img src="<?=base_url('uploads/publication/'.$key->IMAGE_PUBLICATION)?>" alt="" class="img-fluid w-100"/> </a></div>
                                                <?php 
                                                ...
                                                ?> 
                                                <div class="col-lg-6">
                                                    <p class="lead">  <?= $pubs['PUBLICATION']?>  &hellip;</p></div></div>
