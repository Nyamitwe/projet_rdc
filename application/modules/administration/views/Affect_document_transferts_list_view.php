                  ...
                  <div class="col-md-12">
                     <div class="white_shd full margin_bottom_30">
                          ...
                          <div class="full graph_head">
                            ...
                            <div class="row">
                              <div class="col-md-4">
                                 <label style="font-weight: 900; color:#454545" id="PROCESS">Service</label>
                           ...
                           echo '<option value="'.$valu['SERVICE_ID'].'">'.$valu['DESCRIPTION'].'</option>';
                             ...
                             ?>
                              ...
                              <div class="col-md-4">
                                <br>
                        <a href="<?= base_url() ?>administration/Affect_document_transferts" class="btn btn-info btn-block" style="float: right;"><font class="fa fa-plus"></font> Nouveau</a>
                              </div>
                            </div>
                              ...
                              <thead class="">
                               <tr>
                                 <!--   <th style="width:5px">#</th> -->
                                   ...
                                   <th style='width:100px'><center><font color="black" size="3"><label>PROCESSUS</label></font></center></th>
                                  
                                 
                                   <th style='width:70px'><center><font color="black" size="3"><label>Stage</label></font></center></th>

                                    <th style='width:70px'><center><font color="black" size="3"><label>Poste</label></font></center></th>

                                    <th style='width:70px'><center><font color="black" size="3"><label>Documents</label></font></center></th>

                                    <th style='width:70px'><center><font color="black" size="3"><label>Supprimer</label></font></center></th>
                                </tr>
                             </thead>
...
<script>
  ...
  {  
   ...
   $("#mytable").DataTable({
    ...
    "oreder":[[ 1, 'asc' ]],
    "ajax":{
      url: "<?php echo base_url('administration/Affect_document_transferts/get_liste/');?>", 
      type:"POST",
