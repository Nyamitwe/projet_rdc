...
<body>
    ...
    <header>
        <!-- ======= Top Bar start ======= -->
        <section style="background-image: url(../assets/img/bg_pms_header.png)" id="topbar" class="d-flex align-items-center">
            <div class="container d-flex justify-content-center justify-content-md-between">
                <div class="contact-info d-none d-sm-flex align-items-center"> <i class="fa fa-envelope d-flex align-items-center"><a class="topbar_icon" href="mailto:contact@pms.gov.bi">contact@pms.gov.bi</a></i> <i class="fa fa-phone"><a class="topbar_icon" href="tel:+25722248153">+257 22 24 81 53 - Bujumbura,</a><a class="topbar_icon" href="tel:+25722402308">+257 22 40 23 08 - Gitega,</a><a class="topbar_icon" href="tel:+25722302385">+257 22 30 23 85 - Ngozi</a></i> </div>
                <div class="social-links d-flex align-items-center"> <a href=""><i class="fa fa-facebook d-flex align-items-center"></i></a> <a href=""><i class="fa fa-twitter d-flex align-items-center"></i></a> </div>
            </div>
        </section>
        <!-- ======= Top Bar end ======= -->
        <!-- Navbar start -->
        <nav class="navbar navbar-expand-lg navbar-light shadow sticky" data-offset="0">
            <div class="container">
                <a href="#" class="navbar-brand"><img alt="" width='200' src="<?=base_url('assets/img/pms_logo_2.svg')?>"></a>
                ...
                <div class="navbar-collapse collapse" id="navbarContent">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item"> <a class="nav-link active" href="accueil.html#posts">Publications</a> </li>
                        <li class="nav-item"> <a class="nav-link" href="contact.html">Contacts</a> </li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right">
                        <li class="nav-item">
                            <a class="mr-4" style="text-decoration: none" href="#">
                        ...
                        <li class="nav-item">
                            <div class="row d-inline-flex p-5">
                                <div class="col-4"> <a class="font-weight-bold" href="">FR</a> </div>
                                <div class="col-4"> <a href="">EN</a> </div>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <section style="background-image: url(../assets/img/bg_image.png); background-repeat: no-repeat; background-size: cover" class="contact p-3" id="contact">
            ...
            <div class="row pb-5">
                <div class="col-md-8">
                    ...
                    <article class="mb-5 p-3" id="">
                        <header>
                            <div class="meta"><span class="author"><b><i class="fa fa-users"></i> Auteur: Name</b> - </span> <span class="date"><i class="fa fa-clock-o"></i> Publié le  <?=date('d-m-Y',strtotime($article_pub['DATE_PUBLICATION']))?></span> 
                            </div>
                            <h2>
                                <a href="">
                                  <?=$article_pub['OBJET_PUBLICATION']?></a></h2> </header>
                                  <div class="entry-content">
                                    <div class="row">
                                        <div class="col-lg-12 mb-3">
                                          <img src="<?=base_url('uploads/publication/'.$article_pub['IMAGE_PUBLICATION'])?>" alt="" class="img-fluid w-100"/></div>

                                           <div class="col-lg-12">
                                            <p class="lead"><?=$article_pub['PUBLICATION']?> &hellip;</p></div>
                                        </div>
                                    </div>
                                    <footer> </footer>
                                </article>
                    ...
                    <section id="docs" class="doc-section">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="row pt-4 d-flex justify-content-center">
                                    <div class="col-lg-4">
                                        <p class="text-center"><img class="big-hover"      src="<?=base_url('assets/img/house_icon.png')?>">
                                        ...
                                        <div class="col-lg-4">
                                            <p class="text-center"><img class="big-hover"   src="<?=base_url('assets/img/cash_icon.png')?>"
                                                ></p>
                                            <a class="doc-link">
                                                <h4 class="text-center">Méthodes de paiement</h4> </a>
                                            </div>
                                            <div class="col-lg-4">
                                                <p class="text-center"><img class="big-hover"                                          src="<?=base_url('assets/img/id_icon.png')?>"></p>
                                                <a class="doc-link">
                                            ...
                                            <div class="row border-bottom mb-5 pb-4 align-items-center">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-lg-4 mb-md-0 mb-4">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="featured"> <img width="200" src="<?=base_url('assets/img/pms_logo.svg')?>"> </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-lg-4 mb-md-0 mb-4">
