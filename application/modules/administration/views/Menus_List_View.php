                     ...
                     <div class="white_shd full margin_bottom_30">
                       ...
                       <a href="#" class="btn btn-dark" style="float: left;">Liste des menus</a>
                           ...
                           <br>
                            ...
                            <a href="<?=base_url('administration/Enregistrement_Menus')?>" class="btn btn-primary" style="float: right;">Nouveau</a>
                              <br><br>
                              ...
                              <thead class="">
                               <tr>
                                 <!--   <th style="width:5px">#</th> -->
                                   ...
                                   <th style='width:100px'><center><font color="black" size="3"><label>Menu</label></font></center></th>
                                    <th style='width:100px'><center><font color="black" size="3"><label>Type Menu</label></font></center></th>
                                  
                                 
                                   <th><center><font color="black" size="3"><label>Lien</label></font></center></th>
...
<script>
  ...
  {  
   ...
   $("#mytable").DataTable({
    ...
    "oreder":[[ 1, 'asc' ]],
    "ajax":{
      url: "<?php echo base_url('administration/Enregistrement_Menus/get_liste/');?>", 
      type:"POST",
      data : {},
      beforeSend : function() {
      }
