             ...
             <!-- <div class="full price_table padding_infor_info">
                    ...
                    <?php if ($userdef == 2): ?>
                     <div class="full price_table padding_infor_info">
                                  ...
                                  <div class="col-md-6">
                                    <label><h5>personnes affectés</h5></label>
                               
                                <select class="form-control" onchange="get_liste()" name="USER_BACKEND_ID" id="USER_BACKEND_ID">
                                 <option value="">Séléctionner</option>
                                  <?php
    
                          foreach ($selecttoo as $value) {
                        if ($value['USER_BACKEND_ID'] ==set_value('USER_BACKEND_ID')) { ?>
                          <option value="<?= $value['USER_BACKEND_ID'] ?>" selected><?= $value['nom'] ?></option>
                          <?php } else { ?>
                          <option value="<?= $value['USER_BACKEND_ID'] ?>"><?= $value['nom'] ?></option>
                         <?php }
                         } ?> 
                                  </select>
                                   </div>
...
<script type="text/javascript">
  ...
  // ],
      "order":[[0, 'asc' ]],
      "ajax":{
        url:'<?=base_url()?>administration/Liste_Affectation/liste/',
        data:{
