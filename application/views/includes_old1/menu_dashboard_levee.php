...
<div class="row">
        <div class="col-md-3">
            <div class="card border-info mx-sm-1 p-3">
                ...
                <div class="text-info text-center mt-2"><h3><?=$noter?></h3></div>  
            </div>
        </div>
         ...
         <div class="col-md-3">
            <div class="card border-success mx-sm-1 p-3">
                ...
                <div class="text-success text-center mt-2"><h3><?=$ter?></h3></div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card border-warning mx-sm-1 p-3">
                ...
                <div class="text-warning text-center mt-2"><h3>0</h3></div>
            </div>
        </div>
     </div>
     <br>
